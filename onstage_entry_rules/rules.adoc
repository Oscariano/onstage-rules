= RoboCupJunior OnStage Entry Rules 2026
{docdate}
:toc: left
:sectanchors:
:sectlinks:
...
These are the recommended rules of the _RoboCup Federation_ for the _RoboCupJunior_ (RCJ) OnStage Entry events in 2026.
